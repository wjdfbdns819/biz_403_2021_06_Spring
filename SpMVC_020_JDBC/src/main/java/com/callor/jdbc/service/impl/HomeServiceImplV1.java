 ...
 *  필드 멤버 변수를 초기화하는 코드를 갖는 생성자를 만들어 준다
 */
...
public class HomeServiceImplV1 implements HomeService{
	...
	public void dashBoard(Model model) {
		...
		/*
		 * model 객체는 Controller에서 사용하는 view를
		 *  랜더링하는 데이터를 담는 도구이다
		 *  
		 * 3개의 Dao로 부터 데이터를 받아서 Controller로
		 *  return하려면 상당히 불편한 상황이 연출될 수 있다
		 *  
		 * 이때,
		 *  Controller로 부터 model 객체를 매개변수로 받아서
		...
		log.debug("Comps 리스트: {}", compList.toString());
