 ...
 *  NaverBookServiceVImpl2에서는 NaverBookServiceImplV1을 상속받았다
 *  
 ...
 *  
 * 따라서 
 * 	NaverBookServiceImplV2 클래스에는 queryURL(), jsonString(), getNaverList() method가
 *   모두 있는 것과 같다 
 * 	
 */
@Slf4j
...
public class NaverBookServiceImplV2 extends NaverBookServiceImplV1{
	...
	public List<BookDTO> getNaverList(String jsonString) throws Exception {
		...
		// 문자열형 JSON 인 jSonString을 Json 객채로 변환하기
		 ...
		 *  Gson이 특별한 객체 생성자를 하나 제공해 주고,
		 *  이 객체를 통하여 List<DTO>의 구조를 알수 있도록 만들어준다
		 *   
		 */
