...
public class GalleryFilesDTO {
	 ...
	 *  실제로는 1:N의 관계로 생성된 결과이다
	 * 
	 * 하지만 실제로 보여지는 list는 마치 tbl_gallery가 여러개 있는 것처럼 보인다
	 * 
	 * ex) gallery 1개 데이터에 file이 3개 첨부된 경우
	 * 		보여지는 list는 다음과 같다
	 * =====================================================
	 *  1번 gallery에 	1번 파일
	 *  1번 gallery에 	2번 파일
	 ...
	 *  1개만 있으면 될 것을 file 개수 만큼 강제로 생성하는 결과가 된다
	 *  
	 */
	// g(gallery) 와 f(file)의 데이터들은 1:N의 관계임
	private Long g_seq;			//bigint
	private String g_wirter;	//varchar(125)
